...
const REASONS: Reason[] = [
  { icon: Zap, title: "Ships fast", proof: "Fluide AI went from concept to a 53MB Android build in one active sprint." },
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {REASONS.map((r, i) => (
            ...
            >
              <r.icon size={22} className="text-accent mb-4" aria-hidden="true" />
